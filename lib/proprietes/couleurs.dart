...
const Color VERT = Color.fromRGBO(0, 138, 89, 1.0);
...
const Color GRIS_FONCE = Color.fromRGBO(158, 158, 158, 1.0);
const Color BLEU = Colors.blue;

const Color BOUTON_CREATION = VERT;
const Color BOUTON_IMPORTANT = ROUGE;
const Color BOUTON_PRINCIPAL = BLEU_CLAIR;
const Color BOUTON_PRINCIPAL_2 = BLEU_FONCE;
const Color HEADER_FONCE = BEIGE_TRES_FONCE;
const Color HEADER_CLAIR = BEIGE_FONCE;
const Color FOOTER = GRIS_CLAIR;
