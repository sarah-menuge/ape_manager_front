...
class PartageReseau {
  static void shareText(String nom_evenement,DateTime date_debut,DateTime date_fin,String lien, {String subject = '', Rect? sharePositionOrigin}) async {
    String formattedDateDebut = DateFormat('dd/MM/yyyy').format(date_debut);
    String formattedDateFin = DateFormat('dd/MM/yyyy').format(date_fin);
